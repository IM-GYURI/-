...
<html>
	...
	<body>
		...
		<%
			...
			List<BookmarkGroupDTO> bookmarkGroupDTOList = bookmarkGroupDAO.showBookmarkGroupList();
			request.setAttribute("bookmarks", bookmarkGroupDTOList);
		%>
		
		<form method="post" action="http://localhost:5501/Mission1/bookmark-add-list.jsp" id="bookmarks">
	        <select name="gId">
